...
MONGODB_SERVER = "mongodb+srv://James:<db_password>@cluster0.ccbhc.mongodb.net/" # need to insert with password
client = MongoClient(MONGODB_SERVER)  # Replace with your MongoDB URI if using Atlas
